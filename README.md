...
This implementation was originally written by [Leo Zhang](https://github.com/zhangchiqing) without a persistence feature for learning purposes only. However, this fork has an encoding/decoding mechanism, and an added layer of on-disk persistence with LevelDB.
